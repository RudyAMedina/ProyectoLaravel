                            ...
                            @if ($category->peliculas->count() > 0)
                                <div class="mb-8">
                                    ...
                                    <div class="relative group carousel-container">
                                        <!-- Botón anterior -->
                                        <button class="absolute left-0 top-1/2 transform -translate-y-1/2 bg-gray-800 text-white p-2 rounded-full z-10 hover:bg-gray-600 carousel-prev hidden">
                                            ‹
                                        </button>
                                        ...
                                        <!-- Botón siguiente -->
                                        <button class="absolute right-0 top-1/2 transform -translate-y-1/2 bg-gray-800 text-white p-2 rounded-full z-10 hover:bg-gray-600 carousel-next hidden">
                                            ›
                                        </button>
                                    </div>
                                </div>
