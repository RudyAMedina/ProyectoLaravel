...
<body class="font-sans antialiased dark:bg-black dark:text-white/50">
    <div class="bg-gray-50 text-black/50 dark:bg-black dark:text-white/50">
        ...
        <header class="grid grid-cols-2 items-center gap-2 py-10 lg:grid-cols-3">
            <div class="flex lg:justify-left lg:col-start-4">
                <!-- icono de la pagina -->
                <a href="{{ url('/') }}"
            ...
            <nav class="flex items-center space-x-4">
                ...
                <a href="{{ url('/dashboard') }}"
                    class="rounded-md px-6 py-8 text-black ring-1 ring-transparent transition hover:text-black/70 focus:outline-none focus-visible:ring-[#FF2D20] dark:text-white dark:hover:text-white/80 dark:focus-visible:ring-white">
        ...
        <main class="mt-6 container mx-auto px-4">
            <form action="{{ route('peliculas.lista') }}" method="GET" class="mb-8">
                <div class="flex justify-center">
                    <input type="text" name="search" placeholder="Que quieres ver hoy?"
                ...
                <div class="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 gap-6">
                    ...
                    <div class="relative bg-gray-900 rounded-lg overflow-hidden shadow-lg">
                        <a href="{{ route('peliculas.show', $pelicula->id) }}"
                            class="relative bg-gray-900 rounded-lg overflow-hidden shadow-lg">
                            @if($pelicula->image)
            ...
            <div class="container mx-auto py-8">
                ...
                <div class="mb-8">
                    <h2 class="text-2xl font-bold text-gray-800 dark:text-gray-200 mb-4">{{ $category->titulo }}</h2>
                    <div class="relative group">
                        <!-- Botón anterior -->
                        <button
                            class="absolute left-0 top-1/2 transform -translate-y-1/2 bg-gray-800 text-white p-2 rounded-full z-10 hover:bg-gray-600">‹</button>
                        <div class="flex overflow-x-scroll space-x-8 p-4 bg-gray-100 dark:bg-gray-700 rounded-lg">
                    ...
                    <!-- Botón siguiente -->
                    <button
                        class="absolute right-0 top-1/2 transform -translate-y-1/2 bg-gray-800 text-white p-2 rounded-full z-10 hover:bg-gray-600">›</button>
                </div>
            </div>
            @endif
            @endforeach
