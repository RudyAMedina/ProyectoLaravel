                ...
                @foreach ($categories as $category)
                    ...
                    <div class="mb-8">
                        ...
                        <div class="relative px-5">
                            <!-- Botón anterior -->
                            <button class="absolute left-0 top-1/2 transform -translate-y-3/4 bg-gray-800 text-white p-2 rounded-full carousel-prev hidden hover:bg-gray-600">‹</button>
                    ...
                    <!-- Botón siguiente -->
                    <button class="absolute right-0 top-1/2 transform -translate-y-1/2 bg-gray-800 text-white p-2 rounded-full carousel-next hidden hover:bg-gray-600">›</button>
                </div>
            </div>
            @endif
            @endforeach
