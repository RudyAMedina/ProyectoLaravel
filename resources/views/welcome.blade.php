            ...
            <div class="container mx-auto py-8">
                ...
                <h2 class="text-2xl font-bold text-white mb-4">{{ $category->titulo }}</h2>
                    ...
                    <div class="relative group carousel-container">
                        <!-- Botón anterior -->
                        <button
                            class="absolute left-0 top-1/2 transform -translate-y-1/2 bg-gray-800 text-white p-2 rounded-full z-10 hover:bg-gray-600 carousel-prev hidden">
                            ‹
                        </button>
                        <div class="flex overflow-x-scroll space-x-8 p-4 bg-gray-900 dark:bg-gray-700 rounded-lg">
                    ...
                    <!-- Botón siguiente -->
                    <button
                        class="absolute right-0 top-1/2 transform -translate-y-1/2 bg-gray-800 text-white p-2 rounded-full z-10 hover:bg-gray-600 carousel-next hidden">
                        ›
                    </button>
                </div>
            </div>
